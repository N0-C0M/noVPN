...
- [desktop/python](d:/projekt/noVPN/client/desktop/python/README.md) for desktop profile management, multi-server selection, embedded runtime startup, and desktop logging;
